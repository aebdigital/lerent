...
import AutouverImg from '../autouver.jpg'; // Not converted
  ...
  return (
    <div className="min-h-screen text-white" style={{ backgroundColor: '#0d0d0d' }}>
      ...
      <section
        ...
        style={{
          backgroundImage: `url(${AutouverImg})`
        }}
      >
        <div className="absolute inset-0 bg-black/70"></div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 w-full">
          <h1 className="text-4xl md:text-6xl font-bold text-white font-goldman">Autoúvery</h1>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              Ponúkame profesionálne služby autoúverov. Kontaktujte nás pre viac informácií.
            </p>

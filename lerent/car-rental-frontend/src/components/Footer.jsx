  ...
  return (
    <footer className="bg-black text-white py-12">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {/* Main Footer Content - Logo, Contact, Button */}
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-6">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:gap-8">
            ...
            <div className="flex flex-col space-y-2 mb-6 lg:mb-8">
              ...
              <div className="flex items-center space-x-2 text-gray-400 text-sm">
                ...
                <a href="mailto:info@lerent.sk" className="hover:text-white transition-colors">info@lerent.sk</a>
              </div>
              <div className="flex items-center space-x-2 text-gray-400 text-sm">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
                </svg>
                <span>Bratislavská 9, Nitra</span>
              </div>
              <div className="flex items-center space-x-2 text-gray-400 text-sm">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Right Side - Rezervovať Button (hidden on mobile and during booking process) */}
          {!isInBookingProcess && (
        ...
        {/* Social Media Icons - Desktop only, right aligned */}
        <div className="hidden lg:flex justify-end mt-6 lg:-mt-8 mb-8">

      ...
      <section className="pb-0 pt-4 max-[480px]:pb-0 max-[480px]:pt-0 lg:py-12 bg-black overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 max-[480px]:px-2">
          ...
          >
            ...
            <div className="order-1 max-[480px]:order-1 lg:order-1 flex items-center justify-center max-[480px]:justify-start lg:justify-start max-[480px]:min-h-[120px] min-h-[280px]" style={{ zIndex: 2 }}>
              <FadeInUp>
                <div className="h-[280px] max-[480px]:h-[120px] max-[480px]:py-2 flex flex-col justify-center overflow-hidden">
                  <h2
              ...
              <FadeInUp delay={0.1}>
                ...
                >
                  ...
                  {allSlides.map((slide, index) => (
                    <div
                      key={index}
                      className={`absolute inset-0 w-full h-full transition-opacity duration-2000 ${slide.carId ? 'cursor-pointer' : ''
                  ...
                  <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 flex space-x-2 z-10">
                    {allSlides.map((_, index) => (
                      <button
                        ...
                        className={`w-3 h-3 rounded-full transition-all duration-300 ${currentSlide === index ? 'bg-[rgb(250,146,8)] w-8' : 'bg-white/50'
                          }`}
                      />
                    ))}
                  </div>
              ...
              <div className="grid grid-cols-4 lg:grid-cols-8 gap-2 sm:gap-3 lg:gap-4 w-full max-w-7xl">
                {carClasses.map((carClass) => (
                  ...
                  >
                    ...
                    />
                    <span className={`font-goldman font-semibold text-xs sm:text-sm lg:text-base ${activeTab === carClass.value ? 'text-[rgb(250,146,8)]' : 'text-gray-300'
                      }`}>
                      {carClass.name}
                    </span>
                  </button>
                  ...
                  <div className="absolute z-50 w-full mt-2 rounded-lg border border-gray-600 overflow-hidden" style={{ backgroundColor: 'rgb(25, 25, 25)' }}>
                    {carClasses.map((carClass) => (
                      ...
                      >
                        ...
                        />
                        <span className={`font-goldman font-medium ${activeTab === carClass.value ? 'text-[rgb(250,146,8)]' : 'text-gray-300'
                          }`}>
                          {carClass.name}
                        </span>
                      </button>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between mb-8 gap-4">
                ...
                {loadingBrands ? (
                  ...
                  brands.map((brand) => (
                    ...
                    >
                      ...
                      <span className={`text-sm font-goldman font-medium ${selectedBrand === brand.value ? 'text-[rgb(250,146,8)]' : 'text-gray-300'
                        }`}>
                        {brand.name}
                      </span>
                    </button>
              ...
              <div className="sm:hidden w-full px-4 mb-8 flex gap-2">
                    ...
                    <div className="absolute z-50 w-full mt-2 rounded-lg border border-gray-600 overflow-hidden" style={{ backgroundColor: 'rgb(35, 35, 35)' }}>
                      {brands.map((brand) => (
                        ...
                        >
                          ...
                          <span className={`font-goldman font-medium ${selectedBrand === brand.value ? 'text-[rgb(250,146,8)]' : 'text-gray-300'
                            }`}>
                            {brand.name}
                          </span>
                        </button>
                ...
                <div className="relative dropdown-container" style={{ width: '30%' }}>
                  ...
                  >
                    ...
                    <ChevronDownIcon
                      className={`h-4 w-4 text-white transition-transform ${isDropdownOpen ? 'rotate-180' : 'rotate-0'
                        }`}
                    />
                  </button>
              ...
              <div className="relative dropdown-container hidden sm:block">
                ...
                >
                  ...
                  <ChevronDownIcon
                    className={`h-5 w-5 text-white transition-transform duration-300 ${isDropdownOpen ? 'rotate-180' : 'rotate-0'
                      }`}
                  />
                </button>
                  ...
                  <div className="absolute top-full right-0 mt-2 border border-gray-600 rounded-lg shadow-xl z-50 overflow-hidden animate-slideDown" style={{ backgroundColor: '#000000', minWidth: '280px' }}>
                    {sortOptions.map((option, index) => (
                      <button
                        ...
                        className={`w-full px-3 py-2 text-left hover:bg-[rgb(250,146,8)] hover:text-white transition-all duration-200 font-goldman text-xl font-medium leading-none whitespace-nowrap ${sortBy === option.value ? 'bg-[rgba(250,146,8,0.1)] text-[rgb(250,146,8)]' : 'text-white'

        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <a href="tel:+421905318164" className="flex flex-col items-center text-center p-6 rounded-lg border border-gray-800 hover:border-[rgb(250,146,8)] transition-colors duration-200" style={{ backgroundColor: '#111111' }}>
              ...
              <span className="text-gray-400 text-sm mt-1">Zavolajte nám</span>
            </a>
            <a href="mailto:info@lerent.sk" className="flex flex-col items-center text-center p-6 rounded-lg border border-gray-800 hover:border-[rgb(250,146,8)] transition-colors duration-200" style={{ backgroundColor: '#111111' }}>
              ...
              <span className="text-gray-400 text-sm mt-1">Napíšte nám email</span>
            </a>
            <div className="flex flex-col items-center text-center p-6 rounded-lg border border-gray-800" style={{ backgroundColor: '#111111' }}>
              ...
              <span className="text-gray-400 text-sm mt-1">Naša pobočka</span>
            </div>
            <div className="flex flex-col items-center text-center p-6 rounded-lg border border-gray-800" style={{ backgroundColor: '#111111' }}>
              <svg className="w-8 h-8 mb-3" fill="#fa9208" viewBox="0 0 24 24">
              ...
              <span className="text-white font-semibold">Po - Pia: 8:00 - 17:00</span>
              <span className="text-gray-400 text-sm mt-1">Otváracie hodiny</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="rounded-lg p-8 border border-gray-800" style={{ backgroundColor: '#111111' }}>
              <h2 className="text-2xl font-semibold text-white mb-6 font-goldman">Napíšte nám</h2>
              ...
              {submitted ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-300 mb-6">Ozveme sa vám čo najskôr.</p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm text-gray-300 mb-1">Meno a priezvisko *</label>
                      <input
                        type="text"
                        name="name"
                        value={formData.name}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm text-gray-300 mb-1">Telefón</label>
                      <input
                        type="tel"
                        name="phone"
                    ...
                    <div>
                      <label className="block text-sm text-gray-300 mb-1">Predmet</label>
                      <select
                        name="subject"
                      ...
                      >
                        ...
                        <option value="info">Všeobecné informácie</option>
                        <option value="complaint">Reklamácia</option>
                        <option value="cooperation">Spolupráca</option>
                        <option value="other">Iné</option>
                      </select>
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm text-gray-300 mb-1">Správa *</label>
                    <textarea
                      name="message"
                  ...
                  <p className="text-gray-500 text-xs text-center mt-2">
                    * Povinné polia. Kontaktný formulár je momentálne v demo režime.
                  </p>
                </form>
              )}
            </div>

      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-lg">
            {t('bankTransfer.reservationNumber')} <span className="text-[rgb(250,146,8)] font-semibold">{reservationNumber}</span>
          </p>
        </div>
        ...
        <div className="rounded-lg border border-gray-700 p-6 mb-8" style={{ backgroundColor: '#191919' }}>
          <h3 className="text-lg font-semibold text-white mb-4">{t('bankTransfer.nextSteps')}</h3>
          <ol className="space-y-3 text-gray-300">
            <li className="flex items-start gap-3">
              ...
              <span>{t('bankTransfer.step1')}</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[rgb(250,146,8)] flex items-center justify-center text-white text-sm font-bold">
                2
              </span>
              <span>{t('bankTransfer.step2')}</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[rgb(250,146,8)] flex items-center justify-center text-white text-sm font-bold">
                3
              </span>
              <span>{t('bankTransfer.step3')}</span>
            </li>
            <li className="flex items-start gap-3">
              <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[rgb(250,146,8)] flex items-center justify-center text-white text-sm font-bold">
                4
              </span>
              <span>{t('bankTransfer.step4')}</span>
            </li>
          </ol>
        </div>
        ...
        <div className="mt-8 text-center text-gray-400">
          <p>{t('bankTransfer.questionsText')}</p>
